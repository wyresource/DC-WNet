...
if __name__ == '__main__':
    ...
    parser.add_argument("-dp", "--dataset_path", default="/data/wy/ex_vesselseg/code/DC-WNet/DRIVE", type=str,
                        help="the path of dataset")
    parser.add_argument("-wp", "--wetght_path", default="/data/wy/ex_vesselseg/code/DC-WNet/saved/DC_WNet/230516134730/checkpoint-epoch40.pth", type=str,
